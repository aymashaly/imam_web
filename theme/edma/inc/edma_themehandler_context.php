...
$templatecontext = [
    ...
    'userpicture'               => $isloggedin ? new moodle_url('/user/pix.php/'.$USER->id.'/f1.jpg') : null,
    'profile_icon_username'     => $edmaProfileIconUsername,
    'login_url'                 => $login_url,
    'signup_url'                => $signup_url,
    'isloggedin'                => $isloggedin,
    'userfullname'              => $isloggedin ? fullname($USER) : null,
    'userfirstname'             => $isloggedin ? $USER->firstname : null,
    'userlastname'              => $isloggedin ? $USER->lastname : null,
