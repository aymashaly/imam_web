...
class block_hero_landing extends block_base {
    ...
    private function generate_hero_section($title, $subtitle, $description, $cta_text, $cta_url) {
        ...
        .hero-overlay {
            position: absolute;
            inset: 0;
            background-image: linear-gradient(to right bottom, rgba(16, 82, 162, 0.95), rgb(25 88 164 / 72%));
        }
        .hero-content {
            position: relative;
            z-index: 10;
