<?php
$string['pluginname'] = '[Edma] Course Enrolment Custom';
$string['edma_course_enrl'] = '[Edma] Course Enrolment Custom';
$string['edma_course_enrl:addinstance'] = 'Add a new course Enrolment Custom block';
$string['edma_course_enrl:myaddinstance'] = 'Course Enrolment Custom block';
